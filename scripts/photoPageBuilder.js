...
function photoPagebuilder (photographers, medias) {
  const urlSearch = new URLSearchParams(window.location.search)
  const index = parseInt(urlSearch.get('photo'))
  let photographerFromUrl = photographers[index]
  let mediasFromUrl = medias.index
  ...
  const dropdown = document.getElementById('dropdown__header')
